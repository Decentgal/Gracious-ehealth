...
resource "aws_lb" "ehealth_alb" {
  ...
  # checkov:skip=CKV2_AWS_76: "WAF configuration verified for Log4j"
}
...
resource "aws_lb_target_group" "ehealth_tg" {
  ...
  # checkov:skip=CKV_AWS_378: "HTTP used for internal target group"
}
...
resource "aws_lb_listener" "http" {
  ...
  # checkov:skip=CKV_AWS_103: "TLS 1.2 redirection is configured"
}
...
resource "aws_lambda_function" "rotator" {
  ...
  # checkov:skip=CKV_AWS_117: "VPC not required for secret rotation demo"
  # checkov:skip=CKV_AWS_272: "Code signing not required for this demo"
}
...
resource "aws_wafv2_web_acl" "ehealth_waf" {
  ...
  # checkov:skip=CKV2_AWS_31: "WAF Logging not required for this phase"
  # checkov:skip=CKV_AWS_192: "Log4j protection included in Common Rule Set"
}
